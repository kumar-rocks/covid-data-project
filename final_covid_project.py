...
states_code_list = ['TT', 'AN', 'AP', 'AR', 'AS', 'BR', 'CH', 'CT', 'DN', 'DD', 'DL', 'GA', 'GJ', 'HR', 'HP', 'JK',
                    'JH', 'KA', 'KL', 'LA', 'LD', 'MP', 'MH', 'MN', 'ML', 'MZ', 'NL', 'OR', 'PY', 'PB', 'RJ', 'SK',
                    'TN', 'TG', 'TR', 'UP', 'UT', 'WB', 'UN']



raw_date = raw_data['Date'][::3].tolist()
date = pd.to_datetime(raw_date)


d_con = {}
for i in states_code_list:
    con = raw_data[str(i)][::3].tolist()
    d_con["{}".format(i)] = con
    con = []
...
states_code = ['TT', 'AN', 'AP', 'AR', 'AS', 'BR', 'CH', 'CT', 'DN', 'DD', 'DL', 'GA', 'GJ', 'HR', 'HP', 'JK', 'JH',
                   'KA', 'KL', 'LA', 'LD', 'MP', 'MH', 'MN', 'ML', 'MZ', 'NL', 'OR', 'PY', 'PB', 'RJ', 'SK', 'TN', 'TG',
                   'TR', 'UP', 'UT', 'WB']
            ...
            while True:
                ...
                if user_state_name in states_code:
                    ...
                    while True:
                        ...
                        para_3 = input().upper()
                        if para_3 == "CON":
                            print("TOTAL CONFIRMED CASES OF", states_list.loc[user_state_name].to_list()[0], "IS",
